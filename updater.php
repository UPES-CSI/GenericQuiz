...
$answer=$_POST['answer'];
$update = mysql_query("UPDATE $qname SET question='$question',option1='$option1',option2='$option2',option3='$option3',option4='$option4',answer='$answer' WHERE q_no='$u_q_no'");
?>
<!DOCTYPE html>
<html>
